        ...
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          >
            <h2 className="text-xl md:text-3xl lg:text-4xl font-semibold mb-8 leading-tight">
              ...
              <span className="text-accent font-bold">futuro</span> en Pasto y
              Nariño
            </h2>
          </div>
          ...
          >
            <p className="text-lg md:text-xl mb-12 text-white/90 max-w-3xl mx-auto leading-relaxed">
              Una plataforma ciudadana donde reportamos, validamos y celebramos
              acciones que transforman nuestra comunidad hacia un futuro más
              seguro y sostenible.
            </p>
          </div>
