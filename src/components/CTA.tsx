    ...
    <section className="py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="relative container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          {/* Features Preview */}
          <div className="animate-fade-in-up grid grid-cols-1 md:grid-cols-3 gap-6" style={{ animationDelay: '0.4s' }}>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center">
              <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center mx-auto mb-4">
                <Users className="w-6 h-6" />
              </div>
              <h3 className="font-bold mb-2">Comunidad activa</h3>
              <p className="text-sm opacity-80">Conecta con ciudadanos comprometidos</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center">
              ...
              <p className="text-sm opacity-80">Ve resultados reales en tu barrio</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center">
              ...
              <p className="text-sm opacity-80">Interfaz intuitiva y amigable</p>
            </div>
          </div>

          {/* Social Proof */}
          <div className="animate-fade-in-up mt-12 text-center" style={{ animationDelay: '0.6s' }}>
            <p className="text-white/70 mb-4">Únete a cientos de ciudadanos que ya están cambiando Nariño</p>
            <div className="flex justify-center items-center space-x-4">
              <div className="flex -space-x-2">
                {[...Array(5)].map((_, i) => (
                  <div key={i} className="w-8 h-8 rounded-full bg-gradient-to-r from-accent to-primary border-2 border-white"></div>
                ))}
              </div>
              <span className="text-white font-semibold">+500 ciudadanos activos</span>
            </div>
          </div>
        </div>
      </div>
