  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-primary to-secondary text-white shadow-hero hover:shadow-card hover:scale-105 transform transition-all duration-300",
        accent: "bg-accent text-accent-foreground shadow-soft hover:bg-accent/90 hover:shadow-card",
        "primary-soft": "bg-primary-light text-primary border border-primary/20 hover:bg-primary/10 shadow-soft",
        "secondary-soft": "bg-secondary-light text-secondary border border-secondary/20 hover:bg-secondary/10 shadow-soft"
      },
      size: {
